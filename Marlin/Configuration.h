...
#define STRING_CONFIG_H_AUTHOR "(Birbou's Brusa SKR 1.4 Turbo 30.5.21)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Brusa SKR 1.4 Turbo"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 38.10
  #define DEFAULT_bedKi 1.78
  #define DEFAULT_bedKd 544.8
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 142.1 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 5, -1.035 }
